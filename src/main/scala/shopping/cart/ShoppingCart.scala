...
object ShoppingCart {
  ...
  final case class Checkout(cartId: String, replyTo: ActorRef[StatusReply[Summary]])
      extends Command
  ...
  final case class Get(cartId: String, replyTo: ActorRef[Summary]) extends Command
